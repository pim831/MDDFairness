...
toy_data <- read.xlsx("refactored_simulation/datasets/toy/toy_plot_3.xlsx", 
...
plot <- ggplot(toy_data_extended)+
  ...
  geom_point(data = toy_data_extended, aes(perf_acc, perf_spd), size = 10, shape = 11)+
  ...
  geom_point(data = toy_data_extended, aes(maj_acc, maj_spd), size = 10, shape = 13)+
